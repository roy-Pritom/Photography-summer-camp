...
const InstructorCard = ({instructor}) => {
    ...
    <Fade direction="left">
            ...
            <figure className="bg-secondary opacity-90 rounded-l-box border-b-8"><img src={photoUrl} className="w-[110px] h-[100px] rounded-full mx-auto my-12 border-2 border-white
              " alt="car!" /></figure>
